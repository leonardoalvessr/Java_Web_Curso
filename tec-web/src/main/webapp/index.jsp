...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="${pageContext.request.contextPath}/" class="logo">
      ...
      <span class="logo-mini"><b>P</b>rojeto</span>
        ...
        <ul class="nav navbar-nav">
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs">Carlos Barbosa</span>
            </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
       ...
       <li><a href="#"><i class="fa fa-circle-o"></i> Cadastro Cliente</a></li>
       <li><a href="#"><i class="fa fa-circle-o"></i> Cadastro Fornecedor</a></li>
       <li><a href="#"><i class="fa fa-circle-o"></i> Cadastro Funcionário</a></li>
       <li><a href="#"><i class="fa fa-circle-o"></i> Cadastro Usuário</a></li>
      </ul>
    </section>
    <!-- /.sidebar -->
  </aside>
